...
// Set the radius for markers on graph
...
// transform property to place at bottom of the chart.
...
// second label group for the y axis
...
function visualize(theData) {
  ...
  //first placement of data and axes to the scatter plot.
  ...
  // matching labels to circles on graph
  // 
  theCircles
    .append("text")
        .text(function(d) {
